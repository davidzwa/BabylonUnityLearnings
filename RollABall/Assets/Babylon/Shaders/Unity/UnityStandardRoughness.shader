...
Shader "Standard (Roughness setup)"
{
    Properties
    {
		...
		_HighlightIntensity("Highlighting Multiplier", Range(1.0, 25.0)) = 10.0
        ...
        [Enum(UV0,0,UV1,1)] _UVSec ("UV Set for secondary textures", Int) = 0
    ...
    FallBack "VertexLit"
    CustomEditor "StandardRoughnessShaderBJS"
}
