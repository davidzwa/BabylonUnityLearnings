...
namespace BabylonHosting
{
    public static class WebServer
    {
        ...
        private const string CompressExtentions = ".js, .bc, .bin, .hdr, .dds, .mem, .glb, .gltf, .json, .wasm, .data, .babylon, .babylonbinarymeshdata, .babylonbinarygeometrydata";
        ...
        static void WriteResponse(HttpListenerContext context, Stream stream, bool compress = false)
        {
            int packets = 1024 * 32;
            ...
            context.Response.Headers.Add("Content-Payload", "toolkit");
    		context.Response.Headers.Add("Access-Control-Allow-Origin", "*");
			context.Response.Headers.Add("Access-Control-Allow-Headers", "Content-Type");
			context.Response.Headers.Add("Access-Control-Allow-Methods", "GET,POST,PUT,DELETE,OPTIONS");
	        context.Response.Headers.Add("Access-Control-Allow-Credentials", "true");
            stream.CopyTo(output, CopyToOptions.FlushFinal, CompressionMode.Compress, compression, packets);
            output.Close();
        }
