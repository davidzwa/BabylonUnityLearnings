...
namespace UnityEngine
{
    ...
    public static class TextureTools
    {
        ...
        public static bool WriteImageJPG(this Texture2D source, string filename)
        {
            if (source == null) {
            ...
            try {
                byte[] bytes = source.EncodeToJPG(ExporterWindow.exportationOptions.DefaultTextureQuality);
                if (bytes != null) {
        ...
        public static bool WriteImagePNG(this Texture2D source, string filename)
        {
            if (source == null) {
                UnityEngine.Debug.LogException(new Exception("No source image to save to disk: " + filename));
                return false;
        ...
        public static bool WriteImageRAW16(this Texture2D source, string filename, bool flip = true)
        {
            if (source == null) {
                UnityEngine.Debug.LogException(new Exception("No source image to save to disk: " + filename));
                return false;
        ...
        public static Color[] GetSafePixels(this Texture2D texture, Rect? crop = null)
        {
            ...
            {
                if (importTool != null && isReadable == false) importTool.ForceUpdate();
            }
            return pixels;
        }
